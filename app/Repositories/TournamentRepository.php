...
class TournamentRepository
{
    ...
    public function createTournament($user, $attributes)
    {
        ...
        if (isset($attributes['special_event_type_ids'])) {
            $tournament->specialEventTypes()->sync($attributes['special_event_type_ids']);
        }
    ...
    {
        if (isset($attributes['name']) && $tournament->name != $attributes['name']) {
            $attributes['slug'] = Str::slug($attributes['name']);
        }
        ...
        if (isset($attributes['special_event_type_ids'])) {
            ...
            $tournament->specialEventTypes()->sync([]);
        }

        if (isset($attributes['class_ids'])) {
            $tournament->classes()->sync($attributes['class_ids']);
        } else {
