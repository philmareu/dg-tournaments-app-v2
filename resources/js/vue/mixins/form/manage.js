module.exports = {
    ...
    methods: {
        ...
        destroy: function(resource) {
            if(LOAD_GOOGLE_ANALYTICS) ga('send', 'event', 'Tournament Page', 'Edit tournament', 'Delete resource');
        ...
        processResponse: function (response) {
            ...
            if(this.resources === null) this.resource = response.data;
            else this.resources = response.data;

            this.responseProcessedHook(response);
            this.clearValues();
        },
        clearValues: function () {
            if(this.resources !== null) this.resource = this.reset;
            this.status.errors = null;
        },
        closeModal: function () {
            this.clearValues();
