...
@section('summary')
    <a href="{{ $activity->resource->path }}">{{ $activity->resource->name }}</a> registration will close {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $activity->data->closes_at)->diffForHumans() }}
@overwrite
